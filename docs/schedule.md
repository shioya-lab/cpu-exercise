...
R形式
|フィールド名|op|rs|rt|rd|shamt|funct|h
|ビット幅|6|5|5|5|5|6|
I形式
|フィールド名|op|rs|rt|constant|h
|ビット幅|6|5|5|16|
命令の符号化
|命令|形式|op|rs|rt|rd|shamt|funct|address|h
...
## 4回目
* [[シングルサイクルマシン>LSI/チュートリアル/シングルサイクルマシン]] を参考にして，実際の設計をはじめてください．
...
* [[仕様>LSI/仕様]]のページに従って，プログラムのソート以外の部分をつくってください．
* QuartusII で検証を行います
    * QuartusII の追加方はこっち：[[QuartusII>LSI/ツール/QuartusII/12.0]] 

* シングルサイクル・マシンをボード上で動作させることに成功した人は，パイプライン化したプロセッサの設計をはじめてください．
    * パイプライン化する際の注意については，[[高速化に向けて>LSI/高速化に向けて]] を参照してください．
