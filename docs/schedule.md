...
* [チュートリアル](tutorial.md) の加算器とレジスタ・ファイルの2つを各自で実施
    ...
    * 現在の検証は，主に Verilator と GTKWave を用いて行ってください．必要に応じて Vivado XSim を使っても構いません．
...
* 次回の進捗レポートには以下のものを含めて下さい
    * add 命令を解釈して，ソース・オペランドをレジスタ・ファイルから読み込んでいることがわかる実行結果
        ...
        *  実行結果は Verilator + GTKWave，または Vivado XSim の波形ビューアのスクリーンショットを提出してください
