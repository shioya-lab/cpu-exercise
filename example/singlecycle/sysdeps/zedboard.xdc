...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN Y9 [get_ports clkBase]
...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN U10  [get_ports {oledDC}];  # "OLED-DC"
set_property PACKAGE_PIN U9   [get_ports {oledRES}];  # "OLED-RES"
set_property PACKAGE_PIN AB12 [get_ports {oledSCLK}];  # "OLED-SCLK"
set_property PACKAGE_PIN AA12 [get_ports {oledSDIN}];  # "OLED-SDIN"
set_property PACKAGE_PIN U11  [get_ports {oledVBAT}];  # "OLED-VBAT"
set_property PACKAGE_PIN U12  [get_ports {oledVDD}];  # "OLED-VDD"
...
set_property PACKAGE_PIN N15 [get_ports {rst}];  # "BTNL" -- reset
...
## ----------------------------------------------------------------------------
#set_property PACKAGE_PIN G17 [get_ports {rst}];  # "OTG-RESETN"
...
create_clock -period 10.000 -name clkBase -waveform {0.000 5.000} [get_ports clkBase]
